...
timezone () {
# from arch wiki https://wiki.archlinux.org/title/System_time
...
installtype () {
  ...
  LIGHT Install: Installs only apps few selected apps to get you started\n"
  options=(FULL LIGHT)
  select_option $? 4 "${options[@]}"
